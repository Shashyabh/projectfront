...
const HomeRight = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				// const result = await getTaskByType("backlog");
				const result = await getAllTask("backlog");
	...
	return (
		<div className="rightDiv">
			...
			<div className="homeCardDown">
				<div>
					<HomeRightCard title={"Backlog"} data={tasks?.backlog} />
				</div>
				<div>
					<HomeRightCard title={"To-do"} data={tasks?.toDo} />
				</div>
				<div>
					<HomeRightCard title={"In progress"} data={tasks?.inProgress} />
				</div>
				<div>
					<HomeRightCard title={"Done"} data={tasks?.done} />
				</div>
			</div>
